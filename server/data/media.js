module.exports = [{
  title: '블러셔 연결하기',
  description: `잘못바르면 부어보이거나 너무 붉어지는 코럴, 살몬계열 아이섀도우!
청순한 느낌을 살리면서 화사하게 피어나도록 하려면 눈에만 쓰지 말고 뺨에도 사용해보세요~ 사진처럼 눈두덩에 바른 코럴색을 눈 언저리에서 뺨으로 연결해주면 완~~~전 어려 보이는 느낌!
눈 앞머리쪽에 푸른 레이져빔이 살짝 들어간 연보라빛을 발라주면 그렁그렁한 눈매 단박에 완성됩니다!
참, 입술은 욕심내지 마세요. 투명함을 유지할 것! 얼굴 전체의 느낌을 코럴 계열로 통일해주는 것이 이 메이크업의 뽀 인 트!`,
  images: [{
    url: '/static/images/main.jpg',
  }],
  bullets: [{
    style: { left: '68%', top: '10%' },
    product: { index: 0 },
  }, {
    style: { left: '46%', top: '23%' },
    product: { index: 1 },
  }, {
    style: { left: '68%', top: '39%' },
    product: { index: 2 },
  }, {
    style: { left: '83%', top: '44%' },
    product: { index: 3 },
  }, {
    style: { left: '85%', top: '58%' },
    product: { index: 0 },
  }],
  products: [{
    title: '핑크베이지',
